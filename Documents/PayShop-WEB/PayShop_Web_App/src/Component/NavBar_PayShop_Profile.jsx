...
const NavBar_PayShop_Profile = () => {
  ...
  return (
    ...
    >
      ...
      <div
        className="
      bg-[#] w-[80%] h-[55px]  flex items-center justify-between
      z-10    gap-2"
      >
        {/* Image */}
        ...
        {/* warp cart & UserName  */}
        <div className="bg h-auto max-w-max flex gap-3">
          {/* Cart shop */}
          <NavLink
            to={"/Cart"}
            className="bg text-[27px] text-[#537684] cursor-pointer hover:scale-[1.07] transition-[200ms] "
          >
...
export default NavBar_PayShop_Profile;
